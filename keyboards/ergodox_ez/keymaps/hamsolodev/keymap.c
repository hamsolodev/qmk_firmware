...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_ergodox_pretty(
    KC_TILD,        KC_1,           KC_2,           KC_3,           KC_4,           KC_5,           KC_MINUS,                                      KC_EQUAL,      KC_6,           KC_7,           KC_8,           KC_9,           KC_0,           KC_BSPACE,
    ...
    KC_LCTRL,       KC_LGUI,        KC_LALT,        MO(1),          KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,
